            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    ...
                    <div className="relative mt-10 md:mt-24 md:order-2">
                        <div className="absolute inset-x-0 inset-y-0 md:inset-x-2 md:inset-y-6">
                            <div className="w-full h-full max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-purple-400 to-indigo-500 blur-lg filter"></div>
                        </div>
